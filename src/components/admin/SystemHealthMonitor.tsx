...
import { 
  ...
  Clock, AlertTriangle, CheckCircle2, XCircle2,
  Database, Memory, Network, Zap
} from 'lucide-react';
      ...
      <div className="bg-gray-800 rounded-xl p-6">
        ...
        <div className="space-y-3">
          {[
            ...
            >
              {event.type === 'success' && <CheckCircle2 className="w-5 h-5 text-green-500" />}
              {event.type === 'warning' && <AlertTriangle className="w-5 h-5 text-yellow-500" />}
              {event.type === 'error' && <XCircle2 className="w-5 h-5 text-red-500" />}
